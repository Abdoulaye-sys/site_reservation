...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Expediteur::class, mappedBy="user")
     */
    private $expediteurs;
    ...
    public function removeExpediteur(Expediteur $expediteur): self
    {
        if ($this->expediteurs->removeElement($expediteur)) {
            ...
            if ($expediteur->getUser() === $this) {
                $expediteur->setUser(null);
            }
        }
